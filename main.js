...
var map = {
	...
	"./personal/about/about.module": [
		"./src/app/personal/about/about.module.ts",
		"personal-about-about-module"
	],
	"./personal/my-kids/my-kids.module": [
		"./src/app/personal/my-kids/my-kids.module.ts",
		"personal-my-kids-my-kids-module"
	],
	"./personal/person-message/person-message.module": [
...
var routes = [
    ...
    {
        path: "about",
        loadChildren: "./personal/about/about.module#AboutPageModule"
    },
    {
        path: "my-kids",
        loadChildren: "./personal/my-kids/my-kids.module#MyKidsPageModule"
    },
    {
        path: "person-message",
        loadChildren: "./personal/person-message/person-message.module#PersonMessagePageModule"
    }
];
...
module.exports = __webpack_require__(/*! /Users/clark/Documents/personal/web/mobile/appFrame/src/main.ts */"./src/main.ts");
